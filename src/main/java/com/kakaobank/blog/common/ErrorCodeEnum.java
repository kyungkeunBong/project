...
public enum ErrorCodeEnum {
	...
	URL_ENCODE_ERROR("1003", "connector 인코딩 에러"),
	KAKAO_CLIENT_ERROR("1004", "KAKAO_CLIENT_ERROR"),
	KAKAO_INVOCATION_ERROR("1005", "KAKAO SERVER ERROR"),
	KAKAO_UNDEFINED_ERROR("1006", "KAKAO SERVER ERROR"),
	KAKAO_REST_API_KEY_ERROR("1007", "HEADER KEY ERROR");
